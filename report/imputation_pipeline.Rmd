...
- The SNP positions of the initial ADPC file was fixed to match dbSNP 142 chromosome start positions, but not for SNPs with rs IDs - these SNP positions were already correct
